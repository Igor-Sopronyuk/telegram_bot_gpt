...
class ChatGPT3TelegramBot:
    ...
    async def help(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text("/reset - Оновлює бесіду\n"
                                        ...
                                        "/help - Меню помічника\n"
                                        "/english - Помічник з англійської\n",
                                        disable_web_page_preview=True)

    async def english(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        await update.message.reply_text("Ти вибрав розділ для вивчення англійської мови, отже Go!\n"
                                        "Для того щоб, бути більш ефективнішим проведемо тест на знання Англійської мови.",
                                        disable_web_page_preview=True
                                        )
    ...
    def run(self):
        ...
        application.add_handler(CommandHandler('english', self.english))
